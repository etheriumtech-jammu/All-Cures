...
<body>
    ...
    <script>
        var jqueryScript = document.createElement("script");
        jqueryScript.src = "https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js";
        jqueryScript.integrity = "sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q";
        jqueryScript.crossOrigin = "anonymous";
        jqueryScript.async = true;
        document.head.appendChild(jqueryScript);
    </script>
    <script>
        var jqueryScript = document.createElement("script");
        jqueryScript.src = "https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js";
        jqueryScript.integrity = "sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl";
        jqueryScript.crossOrigin = "anonymous";
        jqueryScript.async = true;
        document.head.appendChild(jqueryScript);
    </script><script>
            ...
            a.e=function(e){
                ...
                if(0!==t)if(t)r.push(t[2]);
                    ...
                    i.charset="utf-8",i.timeout=120,a.nc&&i.setAttribute("nonce",a.nc),i.src=function(e){
                        return a.p+"static/js/"+({}[e]||e)+"."+{3:"678f5134"}[e]+".chunk.js"
                    }(e);
                    var c=new Error;
                    u=function(r){
