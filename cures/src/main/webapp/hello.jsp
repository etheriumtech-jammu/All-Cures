...
<body>
    ...
    <script>
        !function(e){
            function r(r){
                for(var n,a,i=r[0],c=r[1],l=r[2],f=0,p=[];f<i.length;f++)
                    a=i[f],Object.prototype.hasOwnProperty.call(o,a)&&o[a]&&p.push(o[a][0]),o[a]=0;
            ...
            a.o=function(e,r){return Object.prototype.hasOwnProperty.call(e,r);};
    ...
    <script src="https://uat.all-cures.com/static/js/main.e590a41d.chunk.js"></script>
</body>
<footer>
    <script type="text/javascript">
        ...
        window._qevents.push({ qacct: "p-V-0EWjCrjcKRm", uid: "allcuresinfo@gmail.com" });
    </script>
    <noscript>
