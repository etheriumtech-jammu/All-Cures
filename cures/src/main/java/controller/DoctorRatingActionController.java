...
/**
 * Servlet implementation class DoctorRatingActionController
 * TODO: Add Exception Handling 
 * TODO: Every API must return some status code to the front end and an error code and error msg if unsuccessful
 */
public class DoctorRatingActionController extends HttpServlet {
	...
	public void rateAssetReq(HttpServletRequest request){
		...
		rateAsset(comments, Integer.parseInt(ratedbyid), Integer.parseInt(targetid), targetTypeid, ratebyTypeid, Float.parseFloat(ratingval));	
	}
