...
public class DoctorsDaoImpl {
	...
	public static Doctors getAllDoctorsInfo(int docid) {
		...
		Query query = session.createNativeQuery("SELECT doctors.docid,doctors.prefix, doctors.docname_first,doctors.docname_middle, "+ 
...
+ "doctors.country_code = countries.countrycodeid and "+
"docid="+docid+";"
);
	...
	public static void saveDoctors(Integer docid ,String f_name,String l_name, String email) {
		...
		try {
			...
			//TODO: This implementation is wrong; Setting the RegistrationID as the Doctors DocId; 
			doc.setDocid(docid);
