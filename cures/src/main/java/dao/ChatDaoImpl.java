...
//		session.getTransaction().commit();
	...
	public static List Chat_List(Integer user_id) {
		...
		Query query = session.createNativeQuery(
				...
				+ "LEFT JOIN registration AS reg ON m.user = reg.registration_id\r\n"
				...
				+ "GROUP BY h.chat_id, reg_doc.first_name, reg_pat.first_name, reg_doc.last_name, reg_pat.last_name, d.docid, reg.registration_id, m.last_time, h.message, h.from_id, h.to_id\r\n"
