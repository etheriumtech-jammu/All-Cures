...
public static Integer sendEmail(int docID, int userID, String roomName, String date, String time) throws IOException {
	    ...
	    try {
	        ...
	        if (docEmail != null) {
	           ...
	           String docLink = "https://uat.all-cures.com:444/cures/notification/join?room=" 
	                    + roomName 
	                    + "&docId=" + docID;
	        ...
	        if (userEmail != null) {
	            ...
	            String encUserEmail = new UserController().getEmailEncrypted(userEmail);
	             String userLink = "https://uat.all-cures.com:444/cures/notification/join?room=" + roomName  + "&userId=" + userID;;
